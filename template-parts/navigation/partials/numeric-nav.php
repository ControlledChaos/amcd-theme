...
if ( ! in_array( 1, $links ) ) {
    ...
    $first_link  = sprintf( '<li%s><a href="%s">%s</a></li>', $class, esc_url( get_pagenum_link( 1 ) ), esc_html( '1', 'amcd-theme' ) );
...
$label = apply_filters( 'amcd_numeric_pagination_label', __( 'Page: ', 'amcd-theme' ) ); ?>
